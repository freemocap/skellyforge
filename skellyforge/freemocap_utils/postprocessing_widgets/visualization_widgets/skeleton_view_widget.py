...
class SkeletonViewWidget(QWidget):
    ...
    def plot_skel(self, frame_number, skel_x, skel_y, skel_z):
        ...
        if self.current_xlim:
            ...
            self.ax.set_xlim(
                [self.mx_skel - self.skel_3d_range, self.mx_skel + self.skel_3d_range]
            )
            self.ax.set_ylim(
                [self.my_skel - self.skel_3d_range, self.my_skel + self.skel_3d_range]
            )
            self.ax.set_zlim(
                [self.mz_skel - self.skel_3d_range, self.mz_skel + self.skel_3d_range]
            )
    ...
    def plot_skeleton_bones(self, frame_number):
        ...
        for connection in this_frame_skeleton_data.keys():
            ...
            bone_x, bone_y, bone_z = (
                ...
                [line_start_point[1], line_end_point[1]],
