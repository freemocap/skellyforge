...
class CameraGroup:
    def __init__(self, cameras: list[Camera], metadata={}):
    ...
    def triangulate_possible(
        ...
        for point_ix in iterator:
            ...
            for picked in itertools.product(*all_iters[point_ix].values()):
                ...
                reprojection_error = cc.reprojection_error(p3d, pts)
                err = cc.calculate_mean_reprojection_error(reprojection_error)
    ...
    def reprojection_error(self, points_3d, points_2d):
    ...
    def bundle_adjust_iter(
        ...
        for i in range(n_iters):
            ...
            errors_full = self.reprojection_error(p3ds, p2ds)
            errors_norm = self.calculate_mean_reprojection_error(errors_full)
    ...
    def average_error(self, p2ds, median=False):
        ...
        mean_errors = self.calculate_mean_reprojection_error(errors)
        if median:
            return np.median(mean_errors)
        else:
