# this is here to avoid importing skellytracker, to keep sub repos from being dependent on each other
import json
import logging
...
try:
    from skellytracker.trackers.base_tracker.base_tracker_abcs import TrackedPointIdString, TrackerTypeString, TrackedPoint2d, BaseObservation, BaseRecorder
